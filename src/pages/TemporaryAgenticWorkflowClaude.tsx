...
const TemporaryAgenticWorkflowClaude = () => (
  <>
    <SEO
      title="Temporary Agentic AI Workflow Preview Claude | Cyoda"
      description="Temporary preview page for the Claude version of the Agentic AI regulated action workflow graph."
      url="/temporary/agentic-ai-workflow-claude"
    />
    <Header />
...
export default TemporaryAgenticWorkflowClaude;
