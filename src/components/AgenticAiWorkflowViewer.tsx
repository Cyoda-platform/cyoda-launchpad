      ...
      <Card className="border-destructive/30 bg-card/80 shadow-sm">
        ...
        <CardContent className="space-y-3 text-sm">
          <p className="text-muted-foreground">
            The supplied Agentic AI workflow JSON did not pass the viewer parser.
          </p>
      ...
      <Card className="overflow-hidden border-border/60 bg-card/80 shadow-sm">
        <CardContent className="p-0">
          <div className="border-b border-border/60 px-5 py-4">
            <p className="text-sm font-medium text-foreground">Agentic AI workflow</p>
            <p className="mt-1 text-sm text-muted-foreground">
              Pan to explore the governed action lifecycle and select a state or transition for details.
            </p>
          </div>
        ...
        <CardContent className="space-y-3 text-sm">
          {!selected && (
            <>
              ...
              <div className="rounded-lg border border-primary/20 bg-primary/[0.03] p-4">
                <p className="font-medium text-foreground">Governed action JSON</p>
                <p className="mt-1 text-muted-foreground">
                  This viewer is driven directly from the Agentic AI workflow file, including
                  policy gates, manual review paths, rollback handling, and monitoring loop-backs.
                </p>
              </div>
            </>
          )}
          ...
          {selected?.kind === 'node' && selected.node.kind === 'startMarker' && (
            <>
              ...
              <p className="text-muted-foreground">
                This marks the initial entry into the governed agentic action lifecycle.
              </p>
            </>
          )}
