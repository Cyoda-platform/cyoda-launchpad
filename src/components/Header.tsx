                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        {
                          label: "Architecture",
                          sub: "How the EDBMS works",
                          to: "/#how-it-works",
                          hash: true,
                        },
                        {
                          label: "Compare vs. alternatives",
                          sub: "Temporal, Camunda, Kafka, XTDB",
                          to: "/comparison",
                        },
                      ].map((item) => (
                    ...
                    <div className="space-y-4">
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <div className="text-xs text-muted-foreground mt-0.5">
                            Full docs at docs.cyoda.net
                          </div>
                        </a>
                      </NavigationMenuLink>
                      <NavigationMenuLink asChild>
                        <a
                          href="https://docs.cyoda.net/api-reference/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block group"
                        >
                      ...
                      <NavigationMenuLink asChild>
                        <Link to="/blog" className="block group">
                          ...
                          <div className="text-xs text-muted-foreground mt-0.5">
                            Engineering and product articles
                          </div>
                        </Link>
                      </NavigationMenuLink>
                    </div>
                ...
                <div className="grid grid-cols-2 w-[520px] gap-6 p-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        {
                          label: "Corporate Loan Origination & Lifecycle",
                          sub: "Borrower company to drawdown",
                          to: "/use-cases/loan-lifecycle",
                        },
                        {
                          label: "Governed Agentic Workflows",
                          sub: "Traceable AI-driven business actions",
                          to: "/use-cases/governed-agentic-workflows",
                        },
                        {
                          label: "Governed Claims Adjudication",
                          sub: "AI-assisted claims lifecycle",
                          to: "/use-cases/governed-claims-adjudication",
                        },
                        {
                          label: "Trade Settlement & Reporting",
                          sub: "Point-in-time queryable trade states",
                          to: "/use-cases/trade-settlement",
                        },
                        {
                          label: "KYC & Customer Onboarding",
                          sub: "Durable retry with full audit",
                          to: "/use-cases/kyc-onboarding",
                        },
                      ].map((item) => (
                        <NavigationMenuLink key={item.label} asChild>
                          <Link to={item.to} className="block group">
                      ...
                      {[
                        {
                          ...
                          sub: "Architecture, team size, compliance",
                          to: "/cto",
                        },
                        {
                          label: "For Developers",
                          sub: "Build, integrate, deploy",
                          to: "/dev",
                        },
                      ].map((item) => (
                        <NavigationMenuLink key={item.label} asChild>
        ...
        <div className="lg:hidden border-t border-border/40 bg-background/95 backdrop-blur">
          <div className="container py-4 space-y-4">
            <nav className="space-y-1">
              <p className="py-1 text-xs font-semibold text-muted-foreground uppercase tracking-widest">
                Platform
              </p>
              <HashLink
                smooth
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block py-1.5 pl-3 text-sm text-muted-foreground hover:text-primary transition-colors"
              >
                Docs
              </a>
              <a
            ...
            <div className="flex flex-col space-y-2 pt-4 border-t border-border/40">
              <Button
                asChild
                variant="outline"
                className="justify-start mobile-btn-text"
              >
                <Link to="/contact">Contact</Link>
              </Button>
            </div>
