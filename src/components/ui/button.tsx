...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
          default: "bg-[hsl(var(--button-bg))] text-[hsl(var(--button-fg))] hover:bg-[hsl(var(--button-hover))]",
        destructive:
      ...
      size: {
        ...
        "mobile-sm": "h-11 px-3 py-2 text-sm [&_svg]:size-3.5 sm:h-9 sm:px-3 sm:[&_svg]:size-3.5",
        "mobile-default": "h-11 px-4 py-2 [&_svg]:size-4 sm:h-10 sm:px-4 sm:[&_svg]:size-4",
        "mobile-lg": "h-12 px-6 py-3 [&_svg]:size-5 sm:h-11 sm:px-8 sm:[&_svg]:size-5",
      },
    },
    defaultVariants: {
      variant: "default",
