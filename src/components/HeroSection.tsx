  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(175,35%,95%) 0%, hsl(175,25%,97%) 100%)",
              ...
              style={{
                background: s.committed
                  ...
                  : s.active
                    ? "hsl(175,50%,52%)"
                    : "hsl(215,15%,80%)",
                boxShadow: s.active ? "0 0 0 3px hsl(175,50%,90%)" : undefined,
              }}
            />
        ...
        {isHomepage ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="max-w-lg lg:max-w-none">
              ...
              >
                Cyoda unifies state, workflow, transactions, and history in one
                model, with one path from local build to regulated production.
                Commercially supported by the people who built it.
              </p>
              ...
              >
                ...
                <span>
                  In production since 2017 · VC Trade, European private debt
                </span>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Build scalable, auditable backend systems on an integrated
              architecture. Commercially supported for regulated and
