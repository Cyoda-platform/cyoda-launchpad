...
// Skeleton for individual blog post cards in the listing
...
// Skeleton for featured blog post cards
export const FeaturedBlogPostSkeleton = () => {
  return (
    <div className="bg-card/20 backdrop-blur border border-border/50 rounded-lg overflow-hidden glow-hover">
      {/* Image skeleton */}
          ...
          <div className="max-w-6xl mx-auto mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Array.from({ length: 3 }).map((_, i) => (
                <FeaturedBlogPostSkeleton key={i} />
              ))}
            </div>
          </div>
